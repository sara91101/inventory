        ...
        <div class="card">
            ...
            <form method="POST" action="{{ route('purchases.store') }}" enctype="multipart/form-data">
                ...
                <div class="card-body row">
                    ...
                    <div class="form-group col-4">
                        <label class="col-form-label">
                        <i class="text-danger">*</i>المورد</label>
                        ...
                        <div id="items-wrapper">
                            <div class="row item-row">
                                ...
                                <div class="form-group col-2">
                                    <label class="col-form-label">
                                        <i class="text-danger">*</i> السعر (بالدولار)
                                    </label>
                                    <input type="number" class="form-control dollar-unit-price" name="dollar_unit_prices[]" required>
                                </div>

                                <div class="form-group col-2">
                                    <label class="col-form-label">
                                        <i class="text-danger">*</i> السعر (بالسوداني)
                                    </label>
                                    <input type="number" class="form-control unit-price" name="unit_prices[]" required>
                                </div>
