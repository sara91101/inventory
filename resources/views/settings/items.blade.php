...
@section('content')
    <script>
        function editItem(id) {
            ...
            form.action = "/expenses-items/" + id; // matches Route::put('/items/{id}')
    ...
    <div class="modal fade" id="add-item" tabindex="-1" role="dialog" aria-labelledby="ModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form method="POST" action="{{ route('expenses-items.store') }}">
                    @csrf
    ...
    <div class="modal fade" id="edit-item" tabindex="-1" role="dialog" aria-labelledby="ModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form method="POST" action="{{ route('expenses-items.store') }}" id="editItemForm">
                    @csrf
                    <div class="modal-body">
                            @method('PUT')
                            <div class="form-group">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <button class="badge badge-danger" onclick="destroyItem('{{ route('expenses-items.destroy', $item->id) }}')"><i class="fa fa-trash-o"></i></button>
                          </td>
                        </tr>
                        @endforeach
                      </tbody>
